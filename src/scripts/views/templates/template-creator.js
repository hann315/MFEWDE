...
<h2 class="content__heading">${restaurant.name} Restaurant Detail</h2>
<div class="detail">
    <img class="lazyload" src="${CONFIG.BASE_IMAGE_URL + restaurant.pictureId}" alt="Picture of ${restaurant.name} Restaurant" />
